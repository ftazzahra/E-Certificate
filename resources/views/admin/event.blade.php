            ...
            <div class="modal-body">
                <form action="{{route ('simpan-event')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggalEv" name="tanggalEv">
                    </div>
                    <div class="mb-3">
                        <label for="namaEv" class="col-form-label">Nama Event:</label>
                        <input type="text" class="form-control" id="namaEv" name="namaEv">
                    </div>
                    <div class="mb-3">
                        <label for="statusEv" class="col-form-label">Status Event:</label>
                        <select name="statusEv" id="statusEv" class="custom-select rounded">
